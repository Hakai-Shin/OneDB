...
class BufferManager{
    ...
    Page insertIntoPool(string tableName, int pageIndex, int pageId);

    public:
    
    BufferManager();
    Page getPage(string tableName, int pageIndex,int pageId);
    ...
    void updatePool(string tableName, int pageIndex, vector<vector<int>> rows, int rowCount,string condition);
