...
/**
 * @brief Function that loads Page indicated by pageId. Now the cursor starts
 * reading from the new page.
 *
 * @param pageIndex
 * @param pageId
 */
void Cursor::nextPage(int pageIndex, int pageId) //TODO replace pageIndex with pageIndex, pageid
{
    logger.log("Cursor::nextPage");
    this->page = bufferManager.getPage(this->tableName, pageIndex, pageId); //TODO repace with pageid
    this->pageIndex = pageIndex;
    this->pagePointer = 0;
}